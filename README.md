...
<section aria-label="GitHub profile trophies">
...
<section aria-labelledby="heading-about">
  <h2 id="heading-about" style="font-size:clamp(1.25rem,2.5vw+.25rem,1.625rem);font-weight:600">About me</h2>
  <ul>
...
<section aria-labelledby="heading-support">
  <h2 id="heading-support" style="font-size:clamp(1.25rem,2.5vw+.25rem,1.625rem);font-weight:600">Support</h2>
  <p>
